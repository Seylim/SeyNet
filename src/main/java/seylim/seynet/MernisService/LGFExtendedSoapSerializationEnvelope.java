...
public class LGFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(LGFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new LGFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static LGFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static LGFDateTimeConverter dateTimeConverter = new LGFStandardDateTimeConverter();

    public LGFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public LGFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new LGFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=LGFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,LGFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=LGFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
