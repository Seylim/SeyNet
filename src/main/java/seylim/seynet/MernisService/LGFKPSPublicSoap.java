...
public class LGFKPSPublicSoap
{
    ...
    public LGFKPSPublicSoap(){}

    public LGFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public LGFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        LGFExtendedSoapSerializationEnvelope envelope= new LGFExtendedSoapSerializationEnvelope(LGFExtendedSoapSerializationEnvelope.VER11);
